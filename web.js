...
if (process.env.NODE_ENV == 'development') {
    ...
    app.set('coinbase_api_key', process.env.COINBASE_API_KEY);
...
app.get('/refresh_orders', function (request, response) {
    console.log("<COINBASE_API_KEY: %s >", process.env.COINBASE_API_KEY);
    https.get("https://coinbase.com/api/v1/orders?api_key=" + app.get("coinbase_api_key"), function (res) {
        var body = '';
